...
var prato = SIMPLEX_GRID([
	[200], 
	[0.5],				
	[400]						
]); 

var prato1= T([0,2])([1,100])(R([0,2])([PI/2])(COLOR([0,1,0])(prato)))

DRAW(prato1)
 
var asfalto = SIMPLEX_GRID([
	[100], 
	[-0.5,0.2],				
	[400]						
]); 

var asfalto1= T([0,2])([1,40])(R([0,2])([PI/2])(asfalto))
